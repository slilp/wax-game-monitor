...
const games: Game[] = [
  ...
  },
  {
    ...
    how: `${baseHowToUrl}spacecraftx`,
    statistic: `${baseStatisticUrl}spacecraftx`,
    calculator: `${baseCalculatorUrl}spacecraftx`,
    game: `${baseGameUrl}spacecraftx`,
  },
  {
    id: "004",
    name: "goldmand",
